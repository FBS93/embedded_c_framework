...
typedef struct
{
    ...
    EDF_timeEvent_t *new_head;   /**< Points to the list of newly armed time events. See note @ref time_event_new_list. */
 ...
 *
 * @note This function must be called once before using any EDF framework feature.
 */
