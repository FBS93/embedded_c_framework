...
ECW is a template for embedded systems development, providing a fully containerized environment with all dependencies preinstalled for fast setup and reproducibility.
