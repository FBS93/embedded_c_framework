...
### Mechanical requirements work product

The mechanical requirements work product shall follow the [Requirements definition](../../resources/requirements_definition.md).

System requirements that do not include `mech` in their domain attribute and system architecture elements not traced to such requirements shall not be considered as input for mechanical requirements definition.
